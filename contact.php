...
<form role="form" method="post" action="<?php echo $_SERVER["PHP_SELF"];?>#contact" id="contact">
 ...
 <div class="form-group">
  ...
  if (isset($_POST["email"])) {
    ...
    if ($mailcheck==FALSE) {
      echo '<p style="color:#f8f8f8; text-shadow:none;">Invalid input</p>';
    } else {
    // sender
      $email = $_POST["email"]; 
      ...
      echo '<p style="color:#f8f8f8; text-shadow:none;">Thanks for contacting me. I\'ll get back to you shortly.</p>';
    }
  }
